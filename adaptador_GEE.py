...
#		 self.GEE_GEOMETRY = ee.Geometry.Point(lat, lon)
	...
	def _get_recurso(self, recurso):
		""" Toma el nombre de un recurso y devuelve un dataframe con el resultado de la consulta de este punto 
		en el producto especificado """
	...
	def _interpolar_serie(self, df, variable):
		""" Toma un df extraido y la columna que se quiere interpolar y devuelve una serie temporal 
		interpolada linealmente funcion interna """
...
#		 self.extraccion_modis_interpolada = s.asfreq("D", method='backfill') ## diferentes metodos de interpolacion (lineal y ultimo valor para atras/adelante)
	...
	def procesar_IV_MODIS(self):
		""" Toma el df de MOD13Q1 generado por alguna de las funciones de extraccion y filtra y procesa 
		el producto MOD13Q1, guarda el resultado en los attributos MOD13Q1_NDVI, MOD13Q1_EVI """
